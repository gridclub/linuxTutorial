...
# Run this chunk in an interactive session to regenerate moretools.csv from
# Google sheet.

library(googlesheets)
sheet <- gs_title("GNU/Linux tools")
sheetdata <- gs_read(sheet)
print(sheetdata)
write.csv(sheetdata, "moretools.csv", row.names = FALSE)
...
moretools <- read.csv("moretools.csv")
datatable(moretools, height = 300, 
